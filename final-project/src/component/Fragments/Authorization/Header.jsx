        ...
        <nav className="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <div className="px-3 py-3 lg:px-5 lg:pl-3">
                ...
                <div className="flex items-center justify-start rtl:justify-end">
                    ...
                    <span className="self-center  font-header text-xl font-semibold  whitespace-nowrap dark:text-white">Dream Job Dashboard</span>
                </div>
                <div className="flex items-center">
                    <button onClick={handleLogout} className="block bg-red-500 rounded-lg text-white px-4 py-1 text-sm hover:text-white hover:bg-red-600 duration-300" >Sign out</button>
